...
public void eventReceived(Action action, T t) {
        ...
        if (action == Action.ADDED) {
                ...
                logger.info("Resource {} modified", resourceName);
